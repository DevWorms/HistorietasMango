    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-body" align="center">
                <p>
                <h1 class="comic" align="center">Muy importante! ¿Eres mayor de edad? 18+</h1></p><br>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li style="margin-top: 12px; margin-right: 6px; margin-left: 6px">
                    <button class="comic comic_btn"><a href="muestra.php" style="text-decoration:none; color:#fff">Pa'
                            atrás</a></button>
                </li>
            </ul>
        </div>
...
<div style="background:#fff; text-align:center;">
    ...
    <h3 class="comix">Todas las historietas dónde quieras y cuando quieras de
        <del>$80</del>
        a sólo <strong>$50</strong> pesitos mensuales</h1>
        <br>
...
<div class="row">
    <div class="col-md-12 col-xs-12 comic" align="center">
        Esta web contiene historietas con alto contenido sexual y su acceso está prohibido a menores de edad de acuerdo
        a la legislación vigente en cada país y región.
    </div>
</div>
<br>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br>
                <p>
                <h1 class="comic">Entrale! </h1></p><br>

                <div class="col-md-5 comix"
                     style="height: 31em; overflow: scroll; background-color:#ff544e; color:#fff">
                    <br>
                    ...
                    <form method="post" id="login_form" action='controladores/sesion/iniciar_sesion.php'>
                        ...
                        <button class="comic comic_btn" id="btn_acceder" name="btn_acceder" style="color:#fefc00">
                            Ingresar
                        </button>
                    </form>
                    ...
                    <a href="registro.php" class="comic comic_btn"
                       style="color:#1866b1; font-size:25px;">REGISTRATE</button>
